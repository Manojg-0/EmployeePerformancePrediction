...
def main():
    ...
    uploaded_file = st.file_uploader(r"C:\Users\manoj\Downloads/Employee data FINAL.xlsx", type=["xlsx"])
    ...
    if uploaded_file is not None:
        ...
        if st.button("Save Inputs to New Excel"):
            ...
            new_file = r"C:\Users\manoj\Downloads/Book1.xlsx"
        ...
        if st.button("Compare Performance"):
            new_data = pd.read_excel(r"C:\Users\manoj\Downloads/Book1.xlsx")
